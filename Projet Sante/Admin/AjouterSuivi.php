            ...
            <div class="card">
              ...
              <form method="POST" id="form-horizontal" class="form-horizontal" enctype="multipart/form-data" action="" >
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="item-select" name="question1" >
                                                            <option value="">Selectionner une question</option>
                                                                <?php
                                                                $listeCategorie=$questionC->afficherQuestions();
                                                                foreach($listeCategorie as $row){
                                                                        echo '<option class="form-group" value="'.$row['question1'].'">'.$row['question1'].'</option>';
                                                                  }
                                                                    ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="item-select" name="question2" >
                                                            <option value="">Selectionner une question</option>
                                                                <?php
                                                                $listeCategorie=$questionC->afficherQuestions();
                                                                foreach($listeCategorie as $row){
                                                                        echo '<option class="form-group" value="'.$row['question2'].'">'.$row['question2'].'</option>';
                                                                  }
                                                                    ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="item-select" name="question3" >
                                                            <option value="">Selectionner une question</option>
                                                                <?php
                                                                $listeCategorie=$questionC->afficherQuestions();
                                                                foreach($listeCategorie as $row){
                                                                        echo '<option class="form-group" value="'.$row['question3'].'">'.$row['question3'].'</option>';
                                                                  }
                                                                    ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="item-select" name="question4" >
                                                            <option value="">Selectionner une question</option>
                                                                <?php
                                                                $listeCategorie=$questionC->afficherQuestions();
                                                                foreach($listeCategorie as $row){
                                                                        echo '<option class="form-group" value="'.$row['question4'].'">'.$row['question4'].'</option>';
                                                                  }
                                                                    ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select class="item-select" name="question5" >
                                                            <option value="">Selectionner une question</option>
                                                                <?php
                                                                $listeCategorie=$questionC->afficherQuestions();
                                                                foreach($listeCategorie as $row){
                                                                        echo '<option class="form-group" value="'.$row['question5'].'">'.$row['question5'].'</option>';
                                                                  }
                                                                    ?>
                                                            </select>
                                                        </div>
